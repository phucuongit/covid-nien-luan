    ...
    >
      ...
      <el-col :md="8" :sm="12" :xs="24">
        <el-card shadow="hover">
          ...
          <el-table :data="dataSearch?.result_tests" style="width: 100%">
            ...
            <el-table-column label="Kết quả">
              <template #default="scope">
                <span v-if="scope?.row?.status == 'negative'">Âm tính</span>
      ...
      <el-col :md="8" :sm="12" :xs="24">
        <el-card shadow="hover">
          ...
          <el-table :data="dataSearch?.vaccinations" style="width: 100%">
            <el-table-column label="Thời gian">
              <template #default="scope">
                {{ formatDate(scope?.row?.created_at) }}
              </template>
